...
GT.WS[ws].LN[1].distanceMax = 14000
...
GT.WS[ws].LN[1].BR = {
                {connector_name = 'Launcher_Arm_1'},
                {connector_name = 'Launcher_Arm_2'},
};

GT.Name = "5p71_V-600P_ln";
GT.DisplayName = _("SAM SA-3 5p71 (V-600P) S-125 LN");
GT.DisplayNameShort = _("SA-3 5p71 (V-600P)");
GT.Rate = 5;
